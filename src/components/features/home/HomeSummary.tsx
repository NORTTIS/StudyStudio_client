...
import { AlertTriangle, CalendarDays, CheckCircle2, Clock3, Layers3 } from "lucide-react";
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="mt-2 font-semibold text-2xl text-gray-900">{value}</p>
                </div>
    ...
    return (
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div className="mb-4 flex items-center justify-between">
                <div>
                    <h2 className="font-semibold text-base text-gray-900">Tiến độ công việc</h2>
                    <p className="mt-1 text-gray-500 text-sm">Tỷ lệ hoàn thành trên tổng số công việc hiện tại</p>
                </div>

                <span className="rounded-md bg-gray-100 px-2.5 py-1 font-medium text-gray-700 text-sm">
                    {percentage}%
                </span>
            </div>
            ...
            <div className="mb-3 flex items-end justify-between gap-4">
                <div>
                    <p className="font-semibold text-3xl text-gray-900">{percentage}%</p>
        ...
        <div className="bg-gray-50">
            <Container className="py-6">
                <div className="mb-6 flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="font-semibold text-2xl text-gray-900">Tổng quan</h1>
                        <p className="mt-1 text-gray-500 text-sm">Theo dõi nhanh công việc và nhóm bạn đang tham gia</p>
                    </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                            <div className="lg:col-span-2">
                                <ProgressCard completed={completedTaskCount} total={totalTasks} />
                            </div>

                            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                                <h2 className="font-semibold text-base text-gray-900">Tóm tắt</h2>
                                <div className="mt-4 space-y-3 text-gray-600 text-sm">
                                    <div className="flex items-center justify-between">
                                        <span>Còn lại</span>
                                        <span className="font-medium text-gray-900">{remainingTaskCount}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span>Quá hạn</span>
                                        <span className="font-medium text-gray-900">{overdueTaskCount}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span>Hoàn thành</span>
                                        <span className="font-medium text-gray-900">{completedTaskCount}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <span>Nhóm tham gia</span>
                                        <span className="font-medium text-gray-900">{totalJoinedGroupCount}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
