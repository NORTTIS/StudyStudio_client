...
import { CheckCircle2, ChevronDown, ChevronUp, Edit3, Save, Star, Users } from "lucide-react";
            ...
            <div className="flex min-h-screen">
                ...
                <main className="flex-1">
                    ...
                    <div className="px-6 py-6">
                        {/* Header */}
                        <div className="mb-6">
                            <h1 className="mb-1 font-bold text-2xl text-[#261E33]">Cấu hình gói đăng ký</h1>
                            <p className="text-[#6F6B99] text-sm">Thiết lập giá và giới hạn cho từng gói dịch vụ</p>
                        </div>
                                    ...
                                    <div
                                        ...
                                        <div className="mb-5 flex items-start justify-between">
                                            ...
                                            <div className="flex gap-2">
                                                {savedId === plan.id && (
                                                    <span className="flex items-center gap-1 rounded-full bg-green-100 px-3 py-1 font-medium text-green-600 text-xs">
                                                ...
                                                {!isEditing && (
                                                    <button
                                                        ...
                                                        className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 font-medium text-[#261E33] text-sm transition-colors hover:border-[#FF5F3D] hover:text-[#FF5F3D]">
                                        ...
                                        {/* Price */}
                                        <div className="mb-5 rounded-xl border border-gray-200 border-dashed bg-white/70 p-4">
                                            <p className="mb-1 font-semibold text-[#6F6B99] text-xs uppercase tracking-wider">
                                                Giá / tháng
                                            </p>
                                            {isEditing ? (
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        className="w-40 rounded-lg border border-[#FF5F3D] px-3 py-2 font-bold text-[#261E33] text-lg focus:outline-none focus:ring-2 focus:ring-[#FF5F3D]/20"
                                                    />
                                                    <span className="font-medium text-[#6F6B99]">VND</span>
                                                </div>
                                            ) : (
                                        ...
                                        <div>
                                            <button
                                                type="button"
                                                className="mb-3 flex w-full cursor-pointer items-center justify-between font-semibold text-[#261E33] text-sm"
                                                ...
                                                <div className="space-y-3">
                                                    {[
                                                        ...
                                                        <div
                                                            ...
                                                            <p className="text-[#6F6B99] text-sm">{field.label}</p>
                                                            {isEditing ? (
                                                                <input
                                                                    type={field.type}
                                                                    value={
                                                                    ...
                                                                    className="w-28 rounded-lg border border-[#FF5F3D] px-3 py-1.5 text-right font-semibold text-[#261E33] text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5F3D]/20"
                                                                />
                                                            ) : (
                                                                <p className="font-semibold text-[#261E33] text-sm">
                                                                    {String(field.value)}
                                                                </p>
                                                            )}
                                                        </div>
                                        ...
                                        {isEditing && (
                                            <div className="mt-5 flex justify-end gap-2">
                                                <button
                                                    type="button"
                                                    onClick={cancelEdit}
                                                    className="cursor-pointer rounded-lg border border-gray-300 px-4 py-2 font-medium text-[#6F6B99] text-sm hover:bg-gray-50">
                                                    Huỷ
                                                </button>
                                                <Button
                        ...
                        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
                            <div className="border-gray-100 border-b px-6 py-4">
                                <h2 className="font-bold text-[#261E33] text-lg">So sánh tính năng</h2>
                            </div>
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {FEATURES.map((feature, i) => (
                                            <tr key={i} className="border-gray-100 border-t">
                                                <td className="px-6 py-4 text-[#261E33] text-sm">{feature.label}</td>
                                                <td className="px-6 py-4 text-center">
                                                    {typeof feature.free === "boolean" ? (
                                                        feature.free ? (
                                                            <CheckCircle2 className="mx-auto h-5 w-5 text-green-500" />
                                                        ) : (
                                                            <span className="mx-auto block h-0.5 w-5 rounded bg-gray-300" />
                                                        )
                                                    ) : (
                                                        <span className="font-medium text-[#261E33] text-sm">
                                                            {feature.free}
                                                        </span>
                                                    )}
                                                </td>
                                                <td className="px-6 py-4 text-center">
                                                    {typeof feature.premium === "boolean" ? (
                                                        ...
                                                        <span className="font-semibold text-[#FF5F3D] text-sm">
                                                            {feature.premium}
                                                        </span>
                                                    )}
                                                </td>
