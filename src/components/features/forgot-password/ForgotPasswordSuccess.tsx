  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-xl">
        ...
        <h1 className="mb-2 text-center font-bold text-2xl">{t("successTitle")}</h1>

        <p className="mb-6 text-center text-muted-foreground text-sm">{t("successInstructions")}</p>
        ...
        <div className="mt-4 flex items-center justify-center gap-2 text-gray-500 transition hover:text-orange-500">
