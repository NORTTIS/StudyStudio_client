/** biome-ignore-all lint/a11y/useValidAnchor: Next.js Link handles navigation semantics */
/** biome-ignore-all lint/a11y/useButtonType: shared Button component wraps semantic button defaults */
"use client";
    ...
    return (
        <div className="flex min-h-screen flex-col bg-[#FFF7ED] text-gray-800">
            ...
            <section className={`relative min-h-[80vh] overflow-hidden bg-white ${fadeIn}`}>
                ...
                <div className={`relative z-10 mx-auto -mt-8 max-w-4xl pt-16 text-center ${fadeUp}`}>
                    <h1 className={`font-extrabold text-5xl text-gray-900 leading-tight ${fadeUp} ${delay1} md:text-6xl`}>
                        {t("hero.title")} <br />
                        {t("hero.subtitle")}
                    </h1>
            ...
            <section className={`bg-[#FFF7ED] py-20 text-center ${fadeUp}`}>
                <h2 className={`font-extrabold text-3xl text-gray-800 ${fadeUp} md:text-4xl`}>{t("architecture.title")}</h2>
                ...
                <div className="mt-14">
                    ...
                    <div className={`mx-auto mt-8 flex h-85 w-[85%] items-center justify-center rounded-lg border-2 border-orange-400 bg-transparent ${fadeUp} ${delay4}`} />

                    <div className={`mt-8 flex justify-center gap-4 ${pop} ${delay5}`}>
                        <Link href={`/${locale}/login`} className="cursor-pointer">
                            <Button className="rounded-full bg-orange-500 px-7 py-5 font-semibold transition-transform duration-300 hover:scale-[1.03] hover:bg-orange-600">
                                {t("management.createButton")}
                            </Button>
                        </Link>

                        <Button className="cursor-pointer rounded-full bg-gray-200 px-7 py-5 font-semibold text-gray-700 transition-transform duration-300 hover:scale-[1.03] hover:bg-gray-300">
            ...
            <section className={`bg-white py-20 text-center ${fadeUp}`}>
                ...
                <p className={`mt-2 text-base text-gray-600 ${fadeUp} ${delay1} md:text-lg`}>{t("group.description")}</p>

                <div className={`mx-auto mt-8 flex h-85 w-[85%] items-center justify-center rounded-lg border-2 border-orange-400 bg-[#FFF7ED] ${fadeUp} ${delay2}`} />
                ...
                <div className={`mt-8 flex justify-center gap-4 ${pop} ${delay3}`}>
                    ...
                    <Button className="cursor-pointer rounded-full bg-[#EDEDED] px-7 py-5 font-semibold text-gray-700 transition-transform duration-300 hover:scale-[1.03] hover:bg-[#E2E2E2]">
                        {t("group.learnMore")}
                    </Button>
                </div>
            </section>
            ...
            <section className={`bg-[#FFF7ED] py-20 text-center ${fadeUp}`}>
                ...
                <div className={`mx-auto mt-8 flex h-85 w-[85%] items-center justify-center rounded-lg border-2 border-orange-400 bg-transparent ${fadeUp} ${delay2}`} />
            ...
            <section className={`bg-white py-20 ${fadeUp}`}>
                <div className="mx-auto w-[90%] max-w-6xl">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className={`rounded-xl border border-gray-200 p-6 ${pop} ${delay1}`}>
                            <h4 className="font-semibold text-gray-800">{t("ai.feature1")}</h4>
                            <div className="mt-6 h-60 rounded-lg border-2 border-gray-300 border-dashed bg-gray-50" />
                        </div>

                        <div className={`rounded-xl border border-gray-200 p-6 ${pop} ${delay2}`}>
