        ...
        <div className="flex min-h-screen flex-col bg-[#FFF7ED] text-gray-800">
            ...
            <section className={"landing-fade-in bg-white py-20"}>
                <div className={"landing-fade-up mx-auto max-w-5xl text-center"}>
                    <h1
                        className={
                            "landing-fade-up landing-delay-1 font-extrabold text-5xl text-gray-700 leading-tight md:text-6xl"
                        }>
                        {t("hero.title")} <br />
            ...
            <section className={"landing-fade-up bg-[#FFF3E6] py-24"}>
                ...
                <div className="mx-auto mt-16 grid max-w-6xl grid-cols-1 gap-10 px-6 md:grid-cols-4">
                    {[t("howToUse.step1"), t("howToUse.step2"), t("howToUse.step3"), t("howToUse.step4")].map(
                        (text, i) => (
                            <div
                                key={i}
                                className={`landing-pop flex flex-col items-center text-center ${stepDelayClasses[i]}`}>
                ...
                <div
                    className={
                        "landing-fade-up landing-delay-4 mx-auto mt-16 flex h-105 w-[85%] items-center justify-center rounded-lg border-2 border-orange-400 bg-transparent"
                    }
                />
            </section>
            ...
            <section className={"landing-fade-up bg-white py-24"}>
                ...
                <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-x-16 gap-y-14 px-6 md:grid-cols-2">
                    <div className={"landing-pop landing-delay-1 rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center"}>
                    ...
                    <div className={"landing-pop landing-delay-2 rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center"}>
                    ...
                    <div className={"landing-pop landing-delay-3 rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center"}>
                    ...
                    <div className={"landing-pop landing-delay-4 rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center"}>
            ...
            <section className={"landing-fade-up bg-[#FFF3E6] py-24"}>
                ...
                <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-16 px-6 md:grid-cols-2">
                    <div className={"landing-pop landing-delay-2 rounded-2xl bg-[#FAD7A7] px-12 py-10 text-center"}>
                    ...
                    <div className={"landing-pop landing-delay-3 rounded-2xl bg-[#FAD7A7] px-12 py-10 text-center"}>
            ...
            <section className={"landing-fade-up bg-white py-20"}>
                <div className="mx-auto w-[90%] max-w-6xl">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className={"landing-pop landing-delay-1 rounded-xl border border-gray-200 p-6"}>
                        ...
                        <div className={"landing-pop landing-delay-2 rounded-xl border border-gray-200 p-6"}>
