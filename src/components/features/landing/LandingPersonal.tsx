  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FFF7ED] text-gray-800">
      ...
      <section className="bg-[#FFF3E6] py-24">
        ...
        <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-y-20 gap-x-40 px-6 md:grid-cols-2">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-3xl font-extrabold text-black">Tạo không gian cá nhân</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-3xl font-extrabold text-black">Thêm ghi chú, tài liệu</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-3xl font-extrabold text-black">Lập kế hoạch học tập</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mt-6 text-3xl font-extrabold text-black">Học tập hiệu quả hơn</h3>
      ...
      <section className="bg-white py-24">
        <h2 className="text-center text-5xl font-extrabold text-gray-600">Bạn có thể làm gì?</h2>
        ...
        <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-x-20 gap-y-16 px-6 md:grid-cols-2">
          <div className="rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center">
            <h3 className="text-2xl font-extrabold text-black">Ghi chú thông minh</h3>
          ...
          <div className="rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center">
            <h3 className="text-2xl font-extrabold text-black">Công việc, mục tiêu</h3>
          ...
          <div className="rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center">
            <h3 className="text-2xl font-extrabold text-black">Tổ chức tài liệu</h3>
          ...
          <div className="rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center">
            <h3 className="text-2xl font-extrabold text-black">Lịch học tập</h3>
          ...
          <div className="rounded-2xl bg-[#FFD9D2] px-10 py-10 text-center">
            <h3 className="text-2xl font-extrabold text-black">Theo dõi tiến độ</h3>
      ...
      <section className="bg-[#FFF3E6] py-24">
        ...
        <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-16 px-6 md:grid-cols-2">
          <div className="rounded-2xl bg-[#FAD7A7] px-12 py-10">
            <h3 className="text-center text-2xl font-extrabold text-black">Học sinh, sinh viên</h3>
          ...
          <div className="rounded-2xl bg-[#FAD7A7] px-12 py-10">
            <h3 className="text-center text-2xl font-extrabold text-black">Người tự học</h3>
      ...
      <section className="bg-orange-400 py-20 text-center text-white">
        <h2 className="text-3xl font-extrabold md:text-4xl">Bắt đầu hành trình học tập của bạn</h2>
