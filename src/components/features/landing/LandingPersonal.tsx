        ...
        <div className="flex min-h-screen scroll-smooth flex-col bg-[#FFF7ED] text-gray-800">
            ...
            <section className="landing-fade-in relative min-h-[80vh] overflow-hidden bg-white">
                ...
                <div className="landing-fade-up relative z-10 mx-auto max-w-4xl px-6 pt-16 text-center">
                    <h1 className="landing-fade-up landing-delay-1 text-5xl leading-tight font-extrabold text-gray-900 md:text-6xl">
                        {t("hero.title")} <br />
                        {t("hero.titleHighlight")}
                    </h1>

                    <p className="landing-fade-up landing-delay-2 mx-auto mt-5 max-w-3xl text-lg text-gray-600 md:text-xl">
                        {t("hero.subtitle")} <br />
            ...
            <section className="landing-fade-up bg-[#FFF3E6] py-24">
                ...
                <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-x-40 gap-y-20 px-6 md:grid-cols-2">
                    <div
                        ...
                        <h3 className="mt-6 text-3xl font-extrabold text-black">{t("howToUse.step1.title")}</h3>

                        <p className="mt-3 whitespace-pre-line text-xl leading-relaxed text-gray-500">
                    ...
                    <div
                        ...
                        <h3 className="mt-6 text-3xl font-extrabold text-black">{t("howToUse.step2.title")}</h3>
                    ...
                    <div
                        ...
                        <h3 className="mt-6 text-3xl font-extrabold text-black">{t("howToUse.step3.title")}</h3>
                    ...
                    <div
                        ...
                        <h3 className="mt-6 text-3xl font-extrabold text-black">{t("howToUse.step4.title")}</h3>
            ...
            <section className="landing-fade-up bg-white py-24">
                <h2 className="landing-fade-up px-6 text-center text-5xl font-extrabold text-gray-600">
                    {t("features.title")}
                </h2>
            ...
            <section className="landing-fade-up bg-[#FFF3E6] py-24">
                ...
                <div className="mx-auto mt-20 grid max-w-6xl grid-cols-1 gap-16 px-6 md:grid-cols-2">
                    <div className="landing-pop landing-delay-2 rounded-3xl bg-[#FAD7A7] px-12 py-10 shadow-sm transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg">
                        <h3 className="text-center text-2xl font-extrabold text-black">{t("users.students.title")}</h3>
