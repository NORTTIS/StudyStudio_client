    ...
    return (
        <div className="min-w-[280px] max-w-[280px] rounded-xl border bg-white">
            <div className="flex items-center justify-between px-3 py-2">
                ...
                <div className="flex items-center gap-2">
                    <span className="grid h-6 min-w-6 place-items-center rounded-md border bg-[#FAFAFA] px-2 text-xs text-[#6F6B99]">
                        {count ?? 0}
                    </span>
                    <button
                        type="button"
                    ...
                    >
                        <span className="text-lg leading-none text-[#6F6B99]">…</span>
                    </button>
                </div>
            </div>
            ...
            <div className="px-3 pb-3">
                <div className="rounded-lg border border-dashed bg-white p-2">
                    <div className="rounded-lg border bg-white p-3 shadow-sm">
                        ...
                        <div className="mt-2 rounded-md border bg-[#FAFAFA] px-2 py-1 text-xs text-[#6F6B99]">
                    ...
                    <button
                        type="button"
                        className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border bg-white py-2 text-sm text-[#261E33] hover:bg-[#FAFAFA]"
                    >
            ...
            <div className="mx-auto max-w-[1280px] px-6 py-6">
                ...
                <div className="mt-4 flex gap-4 overflow-x-auto pb-4">
                    ...
                    <div className="min-w-[280px] max-w-[280px]">
                        <button
                            type="button"
                            className="w-full rounded-xl border bg-white px-4 py-3 text-left text-sm font-medium text-[#261E33] hover:bg-[#FAFAFA]"
                        >
                            Tạo cột mới +
                        </button>
                    </div>
