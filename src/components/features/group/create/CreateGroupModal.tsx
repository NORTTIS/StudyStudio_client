        ...
        <div className="w-full max-w-5xl overflow-hidden rounded-[28px] bg-white shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
          <div className="flex items-start justify-between gap-6 px-8 py-7 sm:px-10">
            <div className="min-w-0">
              ...
              <p className="mt-2 text-sm text-[#6F6B99]">Tạo nhóm học tập mới. Bạn có thể chọn mẫu để bắt đầu nhanh.</p>
            </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-3 relative">
                        <select
                          ...
                          {hasOwnerStudio ? null : <option value="">Bạn chưa có studio nào mà bạn làm chủ</option>}
                          {ownerStudios.map((s) => (
