        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              <div className="relative h-8 w-8 overflow-hidden rounded-full bg-gradient-to-br from-[#FF5F3D] to-[#FF8A7A]">
              ...
              <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-xl border border-[#E5E5E5] bg-white shadow-xl">
                ...
                <div className="border-[#E5E5E5] border-t py-2">
                  <button
                    ...
                    className="flex w-full items-center gap-3 px-4 py-2 text-left text-red-600 text-sm transition-colors hover:bg-red-50">
                    <LogoutIcon />
                    <span>{t("logout")}</span>
                  </button>
                </div>
