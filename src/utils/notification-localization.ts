const VI_EXACT_TEXT_MAP: Record<string, string> = {
    ...
    "Task reassigned": "Đã giao lại công việc",
    "Task reassigned to you": "Công việc được giao lại cho bạn",
...
const EN_EXACT_TEXT_MAP: Record<string, string> = {
    ...
    "Đã giao lại công việc": "Task reassigned",
    "Công việc được giao lại cho bạn": "Task reassigned to you",
    "Công việc đã hoàn thành": "Task completed",
...
const VI_TEXT_REPLACEMENTS: Array<[RegExp, string]> = [
    ...
    [/Task reassigned to you:\s*/gi, "Công việc được giao lại cho bạn: "],
    [/Task reassigned:\s*/gi, "Đã giao lại công việc: "],
    [/Task completed:\s*/gi, "Công việc đã hoàn thành: "],
    [/reassigned task to you:\s*/gi, "đã giao lại công việc cho bạn: "],
    [/reassigned your task:\s*/gi, "đã giao lại công việc của bạn: "],
    [/reassigned task:\s*/gi, "đã giao lại công việc: "],
    [/completed task:\s*/gi, "đã hoàn thành công việc: "],
    [/deleted your task:\s*/gi, "đã xóa công việc của bạn: "],
...
const EN_TEXT_REPLACEMENTS: Array<[RegExp, string]> = [
    ...
    [/Công việc được giao lại cho bạn:\s*/gi, "Task reassigned to you: "],
    [/Đã giao lại công việc:\s*/gi, "Task reassigned: "],
    [/Công việc đã hoàn thành:\s*/gi, "Task completed: "],
    [/đã giao lại công việc cho bạn:\s*/gi, "reassigned task to you: "],
    [/đã giao lại công việc của bạn:\s*/gi, "reassigned your task: "],
    [/đã giao lại công việc:\s*/gi, "reassigned task: "],
    [/đã hoàn thành công việc:\s*/gi, "completed task: "],
    [/đã xóa công việc của bạn:\s*/gi, "deleted your task: "],
