                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-[#6F6B99] text-sm">
                                {t("currentPlan.subtitle")} <span className="font-medium text-[#261E33]">{activePlan.name}</span>.
                            </p>
                            ...
                            <div className="mt-5 flex gap-3">
                                ...
                                {currentPlan !== "free" && <Button variant="outline">{t("currentPlan.cancelButton")}</Button>}
                            </div>
                        </div>
            ...
            <div className="rounded-2xl border bg-white p-8">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    {subscriptionPlans.map((plan) => (
                        <div
                            key={plan.id}
                            className={`rounded-2xl border-2 p-6 transition ${currentPlan === plan.id ? "border-[#FF5F3D] shadow-lg" : "border-[#E5E5E5]"
                                }`}>
                            ...
                            <div className="mt-6 space-y-3 border-t pt-5">
                                {plan.features.map((feature, idx) => (
                                    <p key={idx} className="flex gap-2 text-[#6F6B99] text-sm">
                                        <span className="font-bold text-[#FF5F3D]">✓</span>
                                        {feature}
                                    </p>
                                ))}
            ...
            <div className="rounded-2xl border bg-white p-8">
                ...
                {isEditingInvoice && (
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                <label className="font-semibold text-sm">{t("invoiceInfo.email")}</label>
                                <Input value={invoiceEmail} onChange={(e) => setInvoiceEmail(e.target.value)} />
                            </div>

                            <div>
                                <label className="font-semibold text-sm">{t("invoiceInfo.paymentMethod")}</label>
